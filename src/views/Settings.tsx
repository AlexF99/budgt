import { Box, Card, CardBody, Flex, Heading, IconButton, Spinner, useDisclosure } from "@chakra-ui/react";
...
export const Settings = () => {
    ...
    return (
        <Box>
            ...
            <DeleteDialog onClose={onClose} entityId={categoryId} isOpen={isOpen} path="categories" invalidateQueryId="categories" />
